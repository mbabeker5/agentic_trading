...
- At most {{entries_per_day_max}} new names today, and at most {{max_open_positions}}
...
{"picks":[{"symbol":"ABC","side":"long","entry":12.40,"stop":11.41,"target":null,"qty_hint":400,"rationale":"one sentence"}],"skips":[{"symbol":"XYZ","rationale":"one sentence"}]}

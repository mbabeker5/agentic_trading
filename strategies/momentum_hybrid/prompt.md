...
{"no_action":false,"picks":[{"symbol":"ABC","side":"long","entry":9.38,"stop":9.24,"target":9.66,"qty_hint":1000,"confidence":0.7,"rationale":"one sentence"}],"skips":[{"symbol":"XYZ","rationale":"one sentence"}]}
